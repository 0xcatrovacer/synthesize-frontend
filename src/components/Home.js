     ...
     return(
        ...
        <Userdetails />
         ...
         <div className="Container">
             <text className="pop">Pop</text>
             <div className="slide1"><span className="angleLeft1 sliderButton" onClick={() => handleScroll(-800)} >&#10094;</span>
             <span className="angleRight1 sliderButton" onClick={() => handleScroll(800)}>&#10095;</span></div>

             <text className="hh">Hip Hop</text>
             

             <text className="rock">R&B</text>
             
             <text className="pr">Progressive House</text>
             
             <text className="ed">Dance/Electronic</text>
            ...
            <div className="cards1" ref={ref}>
             ...
             <div className="slide3"><span className="angleLeft3 sliderButton" onClick={() => handleScroll(-800)} >&#10094;</span>
             <span className="angleRight3 sliderButton" onClick={() => handleScroll(800)}>&#10095;</span></div>
             ...
             <div className="slide4"><span className="angleLeft4 sliderButton" onClick={() => handleScroll(-800)} >&#10094;</span>
             <span className="angleRight4 sliderButton" onClick={() => handleScroll(800)}>&#10095;</span></div>
